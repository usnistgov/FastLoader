...
#ifndef INC_3DFASTLOADER_VIRTUAL_FILE_ADAPTIVE_TILE_LOADER_H
#define INC_3DFASTLOADER_VIRTUAL_FILE_ADAPTIVE_TILE_LOADER_H

#include "../../fast_loader/fast_loader.h"

class VirtualFileAdaptiveTileLoader : public fl::AbstractAdaptiveTileLoader<fl::DefaultView<int>> {
  uint16_t const
      fileHeight_ = 0,
      fileWidth_ = 0,
      fileDepth_ = 0,
 ...
 public:
  VirtualFileAdaptiveTileLoader(size_t numberThreads,
    ...
    file_ = std::make_shared<std::vector<int>>(fileDepth_ * fileWidth_ * fileHeight_, 0);
  ...
  std::shared_ptr<AbstractTileLoader> copyTileLoader() override {
    return std::make_shared<VirtualFileAdaptiveTileLoader>(
        this->numberThreads(),
        this->fileHeight_,
        this->fileWidth_,
        this->fileDepth_,
  ...
  [[nodiscard]] short bitsPerSample() const override {
    return sizeof(int);
  }
...
#endif //INC_3DFASTLOADER_VIRTUAL_FILE_ADAPTIVE_TILE_LOADER_H
