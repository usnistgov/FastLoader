...
/// @tparam ViewDataType Internal view's type
...
class FastLoaderMemoryManager
 ...
 private:
  ...
  viewSizePerLevel_ = {}, ///< AbstractView's size for all levels
...
/// @param viewSizePerLevel AbstractView's size for all levels
